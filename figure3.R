...
for (k in 1:length(nol)){
  ...
  write.csv(res, paste0("C:/Users/sypark/Desktop/0PJ2-GSSMD/Results/", savename[[k]]), row.names = FALSE)
}

# read all results
outlier_res <- list.files("C:/Users/sypark/Desktop/0PJ2-GSSMD/Results/", full.names = TRUE)[grep("outlier_lnorm", list.files("C:/Users/sypark/Desktop/0PJ2-GSSMD/Results/"))]
